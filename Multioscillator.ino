...
uint16_t frequencies[8] = {1000,1000,1000,800,700,800,0,0};
...
{          
  	oscil.setFrequency(/*channel*/ 3, (unsigned int)pgm_read_word(&frequency[note])); 
//    	oscil.setFrequency(/*channel*/ 1, 30); 
